...
class TrainSessionArgParser(SessionParser):
    ...
    def initialize(self):
        ...
        self.parser.add_argument("-lr", "--learning_rate", type=float, help="Learning Rate", default=0.01)
        ...
        self.parser.add_argument("-tp", "--train_params", type=str, help="Train Params", default=None)
        self.parser.add_argument("-mt", "--model_type", type=str, help="Model Type", default="AE")
        self.parser.add_argument("-nt", "--no_train", help="No Train", action="store_true", default=False)
        self.parser.add_argument("-it", "--is_testing", help="Is Testing", action="store_true", default=False)
